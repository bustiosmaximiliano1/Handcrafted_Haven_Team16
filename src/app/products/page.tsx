...
import { getFilteredProducts, getProductCategories } from "@/actions/product-actions";
...
export default async function ProductsPage({ searchParams }: ProductsPageProps) {
  ...
  // I resolve categories and products together so this page can render both filter UI and catalog in one server pass.
  ...
  const activeCategoryName =
    categories.find((category) => category.id === activeCategoryId)?.name ?? legacyCategoryName;
